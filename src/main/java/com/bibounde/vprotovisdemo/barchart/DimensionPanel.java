...
public class DimensionPanel implements Page {
    ...
    private TextField chartWidthText, chartHeightText, marginLeftText, marginTopText, marginBottomText, marginRightText, groupInsetText, barInsetText;
    ...
    private void initLayout() {
        ...
        Label groupInsetLabel = new Label("Group inset : ");
        this.content.addComponent(groupInsetLabel, 0, 2);
        this.content.setComponentAlignment(groupInsetLabel, Alignment.MIDDLE_LEFT);

        this.groupInsetText = new TextField();
        this.groupInsetText.setWidth("110px");
        this.content.addComponent(this.groupInsetText, 1, 2);
        this.content.setComponentAlignment(this.groupInsetText, Alignment.MIDDLE_LEFT);

        Label barInsetLabel = new Label("Bar inset : ");
        this.content.addComponent(barInsetLabel, 2, 2);
        this.content.setComponentAlignment(barInsetLabel, Alignment.MIDDLE_LEFT);

        this.barInsetText = new TextField();
        this.barInsetText.setWidth("110px");
        this.content.addComponent(this.barInsetText, 3, 2);
        this.content.setComponentAlignment(this.barInsetText, Alignment.MIDDLE_LEFT);
    }
    ...
    private void initValidator() {
        ...
        this.groupInsetText.addValidator(doubleValidator);
        this.groupInsetText.setImmediate(true);
        this.barInsetText.addValidator(doubleValidator);
        this.barInsetText.setImmediate(true);
    }
    ...
    private void initValues() {
        ...
        this.marginLeftText.setValue("50");
        this.marginBottomText.setValue("50");
    }
    ...
    public Double getGroupInset() {
        return this.groupInsetText.getValue().equals("") ? null : Double.valueOf((String) this.groupInsetText.getValue());
    }
    
    public Double getBarInset() {
        return this.barInsetText.getValue().equals("") ? null : Double.valueOf((String) this.barInsetText.getValue());
    }
}
